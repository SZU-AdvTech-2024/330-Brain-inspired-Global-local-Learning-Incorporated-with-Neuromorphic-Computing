...
for exp in range(exp_num):
    ...
    for epoch in range(num_epochs):
        ...
        for i, (images, labels) in enumerate(train_loader):
            ...
            # 对抗训练：生成对抗样本
            adversarial_images = fgsm_attack(snn, criterion, images, labels, hebb1=hebb1, hebb2=hebb2, epsilon=0.01)

            for i_update in range(num_updates):
                optim_base.zero_grad()
                outputs, spikes, _, hebb1, hebb2, eta1, eta2 = snn(input=adversarial_images, hebb1=hebb1, hebb2=hebb2,
                                                                   wins=time_window)
